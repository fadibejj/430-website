...
{
	mysql_query("UPDATE members SET password='$newpassword' WHERE email='$username'");
	echo "<div style ='font:14px/21px Arial;color:#ff0000'>Password changed</div>";
  ...
  <div class="container">
    <div class="card card-container">
      <!-- <img class="profile-img-card" src="//lh3.googleusercontent.com/-6V8xOA6M7BA/AAAAAAAAAAI/AAAAAAAAAAA/rzlHcD0KYwo/photo.jpg?sz=120" alt="" /> -->
		...
		<button name="submit" class="btn btn-lg btn-primary btn-block btn-signin" type="submit">Change</button>
      </form><!-- /form -->
